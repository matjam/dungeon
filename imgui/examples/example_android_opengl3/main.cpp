...
void init(struct android_app *app) {
    ...
    // - Android: The TTF files have to be placed into the data/ directory (android/app/src/main/data), we use our GetAssetData() helper to retrieve them.
...
// Helper to retrieve data placed into the data/ directory (android/app/src/main/data)
